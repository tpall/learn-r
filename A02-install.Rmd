...
```{r, fig.cap="RStudio window layout. The panel in the upper right contains your workspace. Any plots that you generate will show up in the panel in the lower right corner. The panel on the upper left corner is your source file. The panel on the lower left corner is the console."}
...
```{r, fig.cap="New Project menu."}
knitr::include_graphics("images/RStudio_NewProject.png")
```
...
Relatively minimal folder structure of an R project:
```{r, eval=FALSE}
MyProject/
  |-- R/ # contains R script
