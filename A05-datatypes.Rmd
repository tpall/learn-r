...
```{r, fig.cap="Illustration of R data types. Image: http://yzc.me/2015/12/11/r-intro-1"}
knitr::include_graphics("https://raw.githubusercontent.com/Anonymous-Y/BlogImage/master/r-intro-3.jpg")
```
...
- `dplyr::data_frame()` is a more modern version of data.frame (slight differences for the better)
...
```{r,echo=FALSE, fig.cap="Iris dataset contains sepal and petal measurements of three iris species."}
knitr::include_graphics("http://articles.concreteinteractive.com/wp-content/uploads/2015/03/irises.png")
```
...
Data frames can be indexed in several modes. 
