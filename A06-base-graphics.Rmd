...
```{r, fig.cap="Base R graphics has mojo too, and massive strength. Photo: [wikipedia](https://en.wikipedia.org/wiki/Fat_Bastard_(character))."}
knitr::include_graphics("(https://upload.wikimedia.org/wikipedia/en/7/73/Fat_bastard.jpeg")
```
...
```{r, fig.cap="Normal persons. Are you on the picture? Images: google image."}
knitr::include_graphics("images/normal_person.png")
```
